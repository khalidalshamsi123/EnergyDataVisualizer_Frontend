...
watch([selectedBeforeAfter, selectedHeatDwelling, selectedOptions, selectedAverageSum], async () => {
  ...
  if (!selectedBeforeAfter.value || !selectedHeatDwelling.value || !selectedOptions.value || !selectedAverageSum.value) {
    return;
  }
  ...
  if (selectedAverageSum.value === "average") {
    ...
    title = `Breakdown of average heat demand per ${selectedHeatDwelling.value === "heating_type" ? "heating technology" : "dwelling type"
